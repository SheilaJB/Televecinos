    ...
    <div class="sidebar pe-4 pb-3" style="background-color: #8ecae6;">
        <nav class="navbar" style="background-color: #8ecae6;" >
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="listaIncidencias_S.html" class="nav-link "><i class="fa fa-th-list me-2"></i><span style="font-size: 13.5px;"><b>Incidencias</b></a>
                <a href="BanVecino.html"class="nav-item nav-link"><i class="fa fa-ban me-2"></i><span style="font-size: 13.5px;"><b>Banear vecino</b></a>
                <a href="preguntasFrecuentes_S.html"class="nav-item nav-link active"><i class="fa fa-question-circle me-2"></i><span style="font-size: 13.5px;"><b>Preguntas frecuentes</b></a>
