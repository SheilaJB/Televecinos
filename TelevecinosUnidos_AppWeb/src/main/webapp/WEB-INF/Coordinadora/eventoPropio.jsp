...
<jsp:useBean id="evento" scope="request" type="org.example.televecinosunidos_appweb.model.beans.EventoB"/>
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0 ">
                        <a href="<%=request.getContextPath()%>/VistaServlet?idVista=eventoGeneralesC" class="dropdown-item active"><span style="font-size: 13.5px;"><b>Eventos generales</b></span></a>
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-12 col-xl-6">
                    <div class="rounded h-100 p-4" style = "background-color:#219ebc;">
                        ...
                        <div class="mb-3">
                            <label for="nombreProfesor" class="form-label" style="color:#023047;"><b>Profesor(a):</b></label>
                            <br>
                            <a style="color: white;"> Nombre Apellido_1 </a>
                        </div>
                        <!---Lugar del evento-->
                        <div class="mb-3">
                        ...
                        <br>
                        <a style="color: white;">Miercoles</a>
                        <br>
                        ...
                        <br><label for="VacantesDisponible" class="form-label" style="color:#023047;"><b><br>Vacantes Disponibles:</b> </label>
                        <br>
                        <a style="color: white;">10</a>
