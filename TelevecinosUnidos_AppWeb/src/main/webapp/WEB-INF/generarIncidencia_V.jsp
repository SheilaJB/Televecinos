            ...
            <div class="navbar-nav w-100">
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="generarIncidencia_V.html" class="dropdown-item active"><span style="font-size: 13.5px;"><b>Reportar incidencia</b></a>
                ...
                <div class="columna columna1">
                    ...
                    <form>
                        ...
                        <div class="campo" style="margin-bottom: -35px; ">
                            ...
                            <input type="text" id="otroInput" class="otro-input" placeholder="Escribe aquí"><br>
                        </div>
                        <div class="campo" style="margin-bottom: -35px; ">
                            ...
                            <input type="text" id="otroInput1" class="otro-input" placeholder="Escribe aquí"><br>
                        </div>
                        <div class="campo">
                        ...
                        <div id="popup" class="popup" >
                            <div class="popup_contenido">
                                ...
                                <a href="listaIncidencias.html">
                                    <a href="listaIncidencias_V.html"><button type="button" class="btn btn-primary rounded-pill m-2">Regresar</button></a>
                                </a>
                            </div>
                        </div>
                    </form>
