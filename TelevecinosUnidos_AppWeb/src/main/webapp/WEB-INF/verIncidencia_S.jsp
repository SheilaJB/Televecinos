    ...
    <div class="sidebar pe-4 pb-3" style="background-color: #8ecae6;">
        <nav class="navbar" style="background-color: #8ecae6;" >
            ...
            <div class="navbar-nav w-100">
                <a href="inicioSerenazgo.html" class="nav-item nav-link "><i class="fa fa-home me-2"></i><b>Inicio</b></a>
                <a href="Dashboard.html"class="nav-item nav-link "><i class="fa fa-chart-bar me-2"></i><b>Dashboard</b></a>
                <a href="listaIncidencias_S.html" class="nav-item nav-link active"><i class="fa fa-th-list me-2"></i><b>Incidencias</b></a>
                <a href="BanVecino.html"class="nav-item nav-link"><i class="fa fa-ban me-2"></i><b>Banear vecino</b></a>
                <a href="preguntasFrecuentes_S.html"class="nav-item nav-link "><i class="fa fa-question-circle me-2"></i><b>Preguntas frecuentes</b></a>
            </div>
        </nav>
    </div>
    <!-- Sidebar End -->
