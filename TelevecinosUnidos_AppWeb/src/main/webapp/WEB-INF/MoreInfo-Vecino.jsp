    ...
    <div class="sidebar pe-4 pb-3" style="background-color: #8ecae6;">
        <nav class="navbar" style="background-color: #8ecae6;" >
            ...
            <div class="navbar-nav w-100">
                <a href="inicioVecino.html" class="nav-item nav-link "><i class="fa fa-home me-2"></i><b>Inicio</b></a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-calendar me-2"></i><b>Eventos</b></a>
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="Evento-D-Vecino.html" class="dropdown-item"><b>Deporte</b></a>
                        <a href="Evento-C-Vecino.html" class="dropdown-item "><b>Cultura</b></a>
                        <a href="ListaEvent-Vecino.html" class="dropdown-item"><b>Eventos inscritos</b></a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-th-list me-2"></i><b>Incidencias</b></a>
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="generarIncidencia_V.html" class="dropdown-item"><b>Reportar incidencia</b></a>
                        <a href="listaIncidencias_V.html" class="dropdown-item"><b>Lista de incidencias</b></a>
                    </div>
                </div>
                <a href="preguntasFrecuentes_V.html"class="nav-item nav-link "><i class="fa fa-question-circle me-2"></i><b>Preguntas frecuentes</b></a>
            </div>
        </nav>
    </div>
    <!-- Sidebar End -->
            ...
            <div class="row g-4">
                ...
                <div class="col-sm-12 col-xl-6">
                    ...
                    <select id="tipoIncidencia" name="tipoIncidencia">
                        <option value="opcion1">Lunes-Miércoles-Viernes</option>
                        <option value="opcion1">Martes-Jueves</option>
                        <option value="opcion1">No tiene frecuencia</option>
                    </select>
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                <div class="col" >
                                    ...
                                    <a class="link-opacity-50-hover" style="font-size: small;"href="#">Más información aquí</a>
