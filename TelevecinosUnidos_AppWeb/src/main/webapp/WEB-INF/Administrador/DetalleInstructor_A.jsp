    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0" id="navbar">
            ...
            <a class="navbar-brand mx-4 mb-3 d-flex align-items-center" style="padding-top: 2%;">
                ...
                <h3 class="m-0 me-2 px-2" style="color:#023047;">Detalles del instructor</h3>
            </a>
        ...
        <div style="background-color: #f8f9fa; padding: 20px; align-items: center;">
            ...
            <div class="container text-center">
                <img src="img/instructor.jpg" class="img-fluid mb-3" alt="Responsive image" width="200">
                <div class="bar" data-label="Tipo de Instructor">Deporte</div>
                <div class="bar" data-label="Area a instruir">Futbol</div>
                <div class="bar" data-label="Fecha de contratación">15/06/2024</div>
                ...
                <div id="popup1" class="popup1" >
                    <div class="popup_contenido1">
                        ...
                        <p>La acción "Remover" será permanente, debe estar seguro de su desición al respecto</p>
