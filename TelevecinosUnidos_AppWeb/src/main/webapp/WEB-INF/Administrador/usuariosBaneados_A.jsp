            ...
            <div class="content">
                ...
                <div id="Titulo_Incidencias">
                    <h1 class="display-4 text-center" style="margin-top:20px;margin-bottom:20px;padding: 20px">
                        <h1 style="text-align: center"><i class="fas fa-chalkboard-teacher"></i> Lista de usuarios baneados</h1>
                    </h1>
                    <p class="lead text-center">Observa la lista de usuarios que han sido baneados y desbanea al que desees  </p>
                </div>
                            ...
                            <form method="post" action="<%=request.getContextPath()%>/AdministradorServlet?action=buscarUsuariosBaneadosPorNombre">
                                <div class="col-md-7 mb-2">
                                    <div class="input-group">
                                        ...
                                        <a class="btn btn-secondary" href="<%=request.getContextPath()%>/AdministradorServlet?action=usuariosBaneados_A">
                                            Limpiar
                                        </a>
                                    </div>
                                </div>
                            ...
                            <nav>
                                <ul class="pagination">
                                    <li class="page-item <%= paginaActual == 1 ? "disabled" : "" %>">
                                        <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=usuariosBaneados_A&page=<%= paginaActual - 1 %>">Anterior</a>
                                    </li>
                                    <% if (totalPaginas > 0) { %>
                                    <% for (int i = 1; i <= totalPaginas; i++) { %>
                                    <li class="page-item <%= i == paginaActual ? "active" : "" %>">
                                        <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=usuariosBaneados_A&page=<%= i %>"><%= i %></a>
                                    </li>
                                    <% } %>
                                    <% } else { %>
                                    ...
                                    <li class="page-item <%= paginaActual == totalPaginas || totalPaginas == 0 ? "disabled" : "" %>">
                                        ...
                                        <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=usuariosBaneados_A&page=<%= paginaActual + 1 %>">Siguiente</a>
                                        <% } else { %>
