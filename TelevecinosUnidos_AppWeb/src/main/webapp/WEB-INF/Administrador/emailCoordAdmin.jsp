...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; align-items: center;">
            <h2>Registro de nueva coordinadora</h2>
                ...
                <div class="card  p-4 shadow-lg" style="max-width: 400px; margin: 0 auto;background-color: #b6effb">
                    <div class="form-group text-center">
                        <label>
                            ...
                            <h4 style="margin-top: 20px;">¡Se ha añadido una nueva coordinadora!</h4>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="container" style="padding-top: 20px">
                ...
                <script>
                    function regresar(){
                        window.location.href="ListaCoordinadorasCultura_A.html";
                    }
                </script>
                ...
                <div id="popup" class="popup" >
                    <div class="popup_contenido">
                        ...
                        <a href="#">
                            <a href="ListaCoordinadorasCultura_A.html"><button type="button" class="btn btn-primary rounded-pill m-2">Regresar</button></a>
                        </a>
                    </div>
                </div>
