    ...
    <div class="content">
        ...
        <div id="Titulo_Incidencias">
            <h1 class="display-4 text-center" style="margin-top:20px;margin-bottom:20px;padding: 20px">
                <h1 style="text-align: center"><i class="fas fa-chalkboard-teacher"></i> Lista de coordinadores de cultura</h1>
            </h1>
                    ...
                    <nav>
                        <ul class="pagination">
                            <li class="page-item <%= paginaActual == 1 ? "disabled" : "" %>">
                                <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=listaCoordinadorasCultura_A&page=<%= paginaActual - 1 %>">Anterior</a>
                            </li>
                            <% if (totalPaginas > 0) { %>
                            <% for (int i = 1; i <= totalPaginas; i++) { %>
                            <li class="page-item <%= i == paginaActual ? "active" : "" %>">
                                <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=listaCoordinadorasCultura_A&page=<%= i %>"><%= i %></a>
                            </li>
                            <% } %>
                            <% } else { %>
                            ...
                            <li class="page-item <%= paginaActual == totalPaginas || totalPaginas == 0 ? "disabled" : "" %>">
                                ...
                                <a class="page-link" href="<%=request.getContextPath()%>/AdministradorServlet?action=listaCoordinadorasCultura_A&page=<%= paginaActual + 1 %>">Siguiente</a>
                                <% } else { %>
