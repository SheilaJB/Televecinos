                ...
                <div class="container">
                    <div class="columna columna1">
                        ...
                        <div class="campo">
                            ...
                            <div class="mb-3">
                                <img id="preview" src="ImagenServlet?idImagenIncidencia=<%=incidenciaa.getIdIncidencias()%>" alt="Vista previa de la imagen" class="img-thumbnail" style="display: <%=incidenciaa.getFoto() != null ? "block" : "none"%>;">
