            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="ListaEvent-Vecino.html" class="dropdown-item"><span style="font-size: 13.5px;"><b>Eventos inscriptos</b></a>
                    </div>
                </div>
                <div class="nav-item dropdown">
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="container">
                <div class="columna columna1">
                    ...
                    <div class="m-n2">
                        <a href="listaIncidencias_V.html"></ahref><button type="button" class="btn btn-danger m-2" onclick="">Cancelar incidencia</button> </a>
                    </div>
                ...
                <div class="columna columna2" style="margin-top: 102px;">
                    <form>
                        ...
                        <div class="m-n2">
                            ...
                            <div class="popup" id="popupActualizar">
                                <div class="popup_contenido">
                                    <span class="close-btn" onclick="cerrarPopup()">&times;</span>
                                    <h3>Confirmar actualización</h3>
                                    <h4>¿Estás seguro? </h4>
                                    <a href="listaIncidencias_V.html"><button type="button" class="btn btn-success rounded-pill m-2">Si</button></a>
                                    <a href="actualizarIncidencia_V.html"><button type="button" class="btn btn-danger rounded-pill m-2" >No</button></a>
                                    <!-- Popup Management -->
                                    <script>
