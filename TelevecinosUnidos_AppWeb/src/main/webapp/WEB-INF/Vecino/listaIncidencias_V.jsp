    ...
    <div class="content">
        ...
        <script>
            function viewFunction(idIncidencia) {
                window.location.href ='<%=request.getContextPath()%>/VecinoServlet?action=verIncidencia&idIncidencia=' +idIncidencia;
            }

            function editFunction(idIncidencia) {
                window.location.href ='<%=request.getContextPath()%>/VecinoServlet?action=editarIncidencia&idIncidencia=' + idIncidencia;
            }
        </script>
        <!-- Footer Start -->
