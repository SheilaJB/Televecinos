    ...
    <div class="sidebar pe-4 pb-3" style="background-color: #8ecae6;">
        <nav class="navbar" style="background-color: #8ecae6;" >
            ...
            <div class="navbar-nav w-100">
                <a href="inicioVecino.html" class="nav-item nav-link "><i class="fa fa-home me-2"></i><span style="font-size: 13.5px;"><b>Inicio</b></span></a>
                ...
                <a href="preguntasFrecuentes_V.html" class="nav-item nav-link font-al"><i class="fa fa-question-circle me-2" ></i><span style="font-size: 13.5px;"><b>Preguntas frecuentes</b></span></a>
            </div>
        </nav>
    </div>
    <!-- Sidebar End -->
            ...
            <div class="row my-4" style="margin-bottom: 10px;">
                <div class="col-md-3 mb-4">
                    <div class="card" style="max-width: 20rem; margin: auto;border-radius: 15px;">
                        <img src="img/evento3.jpg" alt="Evento de cultura" style="max-height: 180px;"class="card-img-top rounded-top">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card" style="max-width: 20rem; margin: auto;border-radius: 15px;" >
                        <img src="img/evento1.jpg" alt="Evento de cultura" style="max-height: 180px;"class="card-img-top rounded-top">
                        <div class="card-body" style="height: 15rem;">
                            <h5 class="card-title" style="text-align: left;">Nombre del evento</h5>
                            <p class="card-status"style="font-size: small; margin-bottom: 0;">Estado: Diponible</p>
                            <p class="text-wrap" style="font-size: small; margin-bottom: 0;" style="text-size-adjust:auto; overflow-y: auto;  width: auto;">Fecha de incio: DD/MM/AAAA</p>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card" style="max-width: 20rem; margin: auto;border-radius: 15px;">
                        <img src="img/evento2.jpg" alt="Evento de cultura" style="max-height: 180px;"class="card-img-top rounded-top">
                        <div class="card-body" style="height: 15rem;">
                            <h5 class="card-title" style="text-align: left;">Nombre del evento</h5>
                            <p class="card-status"style="font-size: small; margin-bottom: 0;">Estado: Diponible</p>
                            <p class="text-wrap" style="font-size: small; margin-bottom: 0;" style="text-size-adjust:auto; overflow-y: auto;  width: auto;">Fecha de incio: DD/MM/AAAA</p>
