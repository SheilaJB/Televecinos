        ...
        <div class="container-fluid d-flex justify-content-center align-items-center vh-100">
            <div class="container text-center">
                ...
                <script>
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "<%=request.getContextPath()%>/SerenazgoServlet?action=cambiarContrasena";
                        }
                    });
                </script>
                ...
                <div class="container">
                    ...
                    <form method="post" action="<%= request.getContextPath() %>/SerenazgoServlet?action=contrasenaActual">
                        <div class="mb-3">
