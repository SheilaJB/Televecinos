    ...
    <div class="content">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; align-items: center;">
            ...
            <div class="container text-center">
                ...
                <a href="<%=request.getContextPath()%>/SerenazgoServlet?action=cambiarContrasena"><button class="button cambiarContra btn-banear">Cambiar contraseña</button></a>
                <a href="<%=request.getContextPath()%>/SerenazgoServlet?action=cambiarTelefono_S&idSereno=<%=serenazgoLogeado.getIdSerenazgo()%>"><button class="button cambiarTelefono btn-banear">Cambiar telefono</button></a>
