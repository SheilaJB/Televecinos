...
<head>
    <meta charset="utf-8">
    <title>Preguntas frecuentes vecinos</title>
        ...
        <nav class="navbar" style="background-color: #8ecae6;" >
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="preguntasFrecuentes_V_vistaAdmin.html" class="dropdown-item active"style="font-size: 13.5px;">Dudas Vecinos</a>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0" id="navbar">
            ...
            <a class="navbar-brand mx-4 mb-3 d-flex align-items-center" style = "padding-top: 2%;">
                ...
                <h3 class="m-0 me-2 px-2" style="color:#023047;">Preguntas frecuentes de los vecinos</h3>
            </a>
